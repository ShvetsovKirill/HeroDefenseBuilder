...
namespace HeroDefense.Waves
{
    ...
    public sealed class EnemyDefinition : ScriptableObject
    {
        ...
        [Tooltip("С какого расстояния враг атакует цель.\n\n" +
                 "Ближний бой ~2.5, лучник 8–10. Раньше дистанция была общей " +
                 "для всех в EnemyManager — из-за этого Ranged механически " +
                 "ничем не отличался от Runner, и его роль «ломает безопасную " +
                 "позицию» не работала.")]
